...
setup(
    name='cookiecutter-websauna-app',
    version='1.0.0a1',
    description='Cookiecutter template to create a Websauna application.',
    ...
    url='https://github.com/websauna/cookiecutter-websauna-app',
    packages=[],
